...
export default function CarAlarmPage() {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      <main className="mx-auto max-w-4xl px-4 py-10">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
          ...
          <h1 className="text-4xl font-black text-gray-900 mb-4 uppercase">Car Alarm & Tracker</h1>
          <p className="text-xl text-gray-500 font-medium mb-8">
            Protect your vehicle with our high-end security systems. We offer mobile installation for alarms and GPS tracking units.
          </p>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  'Shock & Proximity Sensors',
                  'Engine Immobilizer Setup',
            ...
            <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-black text-gray-900">3 Hours</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-500 font-bold uppercase text-sm">Base Price</span>
                  <span className="font-black text-blue-600 text-xl">Ksh 8,500</span>
                </div>
                <div className="flex justify-between items-center">
              ...
              <Link 
                href="/services/request?type=Car%20Alarm%20%26%20Tracker%20Installation"
          ...
          <div className="border-t pt-10">
            <h3 className="text-2xl font-black mb-6 uppercase">Maximum Security</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { title: '24/7 Tracking', desc: 'Monitor your car from anywhere via mobile app.' },
                { title: 'No Wire Cutting', desc: 'Professional installation preserving your warranty.' },
                { title: 'Fleet Ready', desc: 'Solutions for individual cars or large fleets.' }
              ].map((item) => (
                <div key={item.title}>
