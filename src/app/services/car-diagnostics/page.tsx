    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
      <main className="mx-auto max-w-4xl px-4 py-10">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
          ...
          <h1 className="text-4xl font-black text-gray-900 mb-4 uppercase">Car Diagnostics</h1>
          <p className="text-xl text-gray-500 font-medium mb-8">
            Comprehensive vehicle computer diagnostics and 50-point inspection to identify any hidden issues.
          </p>
            ...
            <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-black text-gray-900">1 Hour</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-500 font-bold uppercase text-sm">Base Price</span>
                  <span className="font-black text-blue-600 text-xl">Ksh 2,500</span>
                </div>
                <div className="flex justify-between items-center">
              ...
              <Link 
                href="/services/request?type=Car%20Diagnostics"
          ...
          <div className="border-t pt-10">
            <h3 className="text-2xl font-black mb-6 uppercase">Why Choose Our Diagnostics?</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { title: 'Expert Techs', desc: 'Certified professionals with years of experience.' },
                { title: 'Latest Tools', desc: 'We use state-of-the-art diagnostic equipment.' },
                { title: 'Full Report', desc: 'Get a detailed digital report of your car condition.' }
              ].map((item) => (
                <div key={item.title}>
